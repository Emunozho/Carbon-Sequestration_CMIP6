...
\author{Estefanía Muñoz, Holger Metzler, Marcos Fernández-Martínez, Jacob A. Nelson, Michael O'Sullivan, Stephen Sitch, Tobias Nützel, Jens Heinke, George Hurtt, Lei Ma, Qing Sun, Patrick C. McGuire, Etsushi Kato, Xiaojuan Yang, Wenping Yuan and Carlos A. Sierra}
        ...
        \begin{tabular}{m{3cm} m{4cm} m{4cm} m{4cm}}
            ...
            \textbf{Computation} &
                $\begin{array}{c}
                    ...
                    \displaystyle = \intl_{t_0}^{t_0+T} \intl_{t'}^{t_0+T} \itPhi(t,t',\vec{s}(t'))\dd{t}\dd{t'}\\
            ...
            \begin{itemize}
                ...
                \item Or $\IITT$ requirements and initial carbon stock vector $\vec{C}(t_0)$.
            \end{itemize} &
            \begin{itemize}
...
CABLE-POP      & Yes          & Yes          & Haverd et al. \cite{Haverd2018}                                                                                                                \\
CLASSIC        & Yes          & Yes          & Melton et al. \cite{Melton2020}, Assadi et al. \cite{Asaadi2018}                                                                                                               \\
CLM5.0         & Yes          & Yes          & Lawrence et al. \cite{Lawrence2019}                                                                                                              \\
DLEM           & Yes          & No           & Tian et al. \cite{Tian2015}, You et al. \cite{You2022}                                                                                               \\
ED             & Yes          & Yes          & Moorcroft et al. \cite{Moorcroft2001}, Ma et al. \cite{Ma2022}                                                                                           \\
ELM            & Yes          & Yes          & Yang et al. \cite{Yang2023}, Burrows et al. \cite{Burrows2020}                                                                                            \\
IBIS           & Yes          & Yes          & Xia et al. \cite{Xia2024}                                                                                                                   \\
iMAPLE         & Yes          & Yes          & Yue et al. \cite{Yue2024}                                                                                                                   \\
ISAM           & Yes          & Yes          & Jain et al. \cite{Jain2013}, Meiyappan et al. \cite{Meiyappan2015}, Shu et al. \cite{Shu2020}                            \\
ISBA-CTRIP& Yes          & Yes          & Delire et al. \cite{Delire2020}                                                                                                               \\
JSBACH         & Yes          & Yes          & Mauritsen et al. \cite{Mauritsen2019}, Reick et al. \cite{Reick2021}                                                                                        \\
JULES          & Yes          & Yes          & Wiltshire et al. \cite{Wiltshire2021}, Sellar et al. \cite{Sellar2019}, Burton et al. \cite{Burton2019} 
\\
LPJml          & Yes          & No           & \begin{tabular}[c]{@{}l@{}}Schaphoff et al. \cite{Schaphoff2018}, von Bloh et al. \cite{vonBloh2018},\\ Lutz et al. \cite{Lutz2019}, Heinke et al. \cite{Heinke2023}\end{tabular} \\
LPJwsl         & Yes          & Yes          & Poulter et al. \cite{Poulter2011}                                                                                                               \\
LPX-Bern            & Yes          & Yes          & Lienert and Joos \cite{Lienert2018}                                                                                                            \\
OCN            & Yes          & Yes          & Zaehle and Friend \cite{Zaehle2010}, Zaehle et al. \cite{Zaehle2011}                                                                                      \\
ORCHIDEE       & Yes          & Yes          & \begin{tabular}[c]{@{}l@{}}Krinner et al. \cite{Krinner2005}, Zaehle and Friend \cite{Zaehle2010}, \\ Vuichard et al. \cite{Vuichard2019}\end{tabular}                  \\
SDGVM          & Yes          & No           & Woodward and Lomas \cite{Woodward2004}, Walker et al. \cite{Walker2017}                                                                                     \\
VISIT          & Yes          & Yes          & Ito and Inatomi \cite{Ito2012}, Kato et al. \cite{Kato2013}                                                                                          \\
